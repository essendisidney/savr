-- Branch-aware shopper tips (optional location; falls back to first branch)

drop function if exists public.submit_crowdsource_price(uuid, uuid, integer);
...
grant execute on function public.submit_crowdsource_price(uuid, uuid, integer, uuid) to authenticated;
